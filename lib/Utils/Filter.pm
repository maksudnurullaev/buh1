...
=cut
    ...
    sub get_pagesize_path {
        my $self = shift;
        return ( get_unique_path( $self, '/pagesize' ) );
    }

    sub get_page_path {
        my $self = shift;
        return ( get_unique_path( $self, '/page' ) );
    }

    sub get_pages_path {
        my $self = shift;
        return ( get_unique_path( $self, '/pages' ) );
    }

    sub get_filter_path {
        my $self = shift;
        return ( get_unique_path( $self, '/filter' ) );
    }
    ...
    sub get_pagesize {
        my $self = shift;
        return ( $self->session->{ get_pagesize_path($self) }
              || $DEFAULT_PAGESIZE );
    }
